...
/*   Updated: 2021/11/26 12:26:50 by cshanda          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "cub3d.h"
...
int	hook_keypress(int keycode, t_vars *data)
{
	...
	if (keycode == 2)
		data->key.straferight_key = true;
	else if (keycode == 0)
		data->key.strafeleft_key = true;
	else if (keycode == 13)
...
{
	if (keycode == 2)
		data->key.straferight_key = false;
	else if (keycode == 0)
		data->key.strafeleft_key = false;
	else if (keycode == 13)
